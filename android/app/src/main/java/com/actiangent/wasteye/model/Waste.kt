...
enum class Waste(
    ...
    CARDBOARD(
        ...
        sortation = listOf(
            "Separate cardboard from other waste, especially contaminated ones. Make sure the cardboard is dry and clean.",
            "Fold or cut the cardboard into smaller pieces for easier storage and transport."
        ),
    ...
    GLASS(
        ...
        sortation = listOf(
            "Separate glass by colour and type.",
            "Make sure to handle broken glass with care to avoid injury."
        ),
    ...
    METAL(
        ...
        sortation = listOf(
            "Separate metals by type, such as aluminium and iron, as they have different recycling processes.",
            "Clean the metals from food debris or other materials to facilitate the recycling process."
        ),
    ...
    PAPER(
        ...
        sortation = listOf(
            "Separate clean paper from contaminated paper.",
            "Clean paper includes newspapers, magazines, and office paper, while contaminated paper includes used tissues, greaseproof paper, or plastic-coated paper."
        ),
    ...
    PLASTIC(
        ...
        sortation = listOf(
            "Separate plastics by type and recycling code.",
            "Clean the plastic from food residue or other materials to prevent contamination that can hinder the recycling process."
        ),
